 ...
 * - GlassBorderStyle.bodyAlpha remains as a compatibility field for the legacy unified backdrop chain.
 * - The unused legacy OpenGLGlassViewportLayer renderer was removed to avoid maintaining a second OpenGL path.
