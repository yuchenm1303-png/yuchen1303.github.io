...
data class BackdropDebugParams(
    ...
    val customImageBrightness: Float = 0.70f,
    val customImageHighlightStart: Float = 0.65f,
    val customImageHighlightLimit: Float = 0.80f,
...
data class GlassBorderStyle(
    ...
    val newOpenGlBodyLensDark: Float = 1.6f,
