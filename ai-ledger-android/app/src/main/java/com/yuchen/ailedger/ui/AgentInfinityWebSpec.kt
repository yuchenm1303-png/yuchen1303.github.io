...
internal val AgentInfinityOffTheme = AgentInfinityWebTheme(
    NativeColor.rgb(104, 117, 151), NativeColor.rgb(92, 102, 133), NativeColor.rgb(127, 139, 169), 0.015f, 0f
)
internal val AgentInfinityStandbyTheme = AgentInfinityWebTheme(
    NativeColor.rgb(102, 255, 240), NativeColor.rgb(93, 132, 255), NativeColor.rgb(164, 105, 255), 0.03f, 0.42f
)
